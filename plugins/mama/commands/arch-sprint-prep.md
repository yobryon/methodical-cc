...
Review the project state and present your sprint proposal. End by inviting the user to share their feedback via `/mama:arch-feedback` (or they may just respond conversationally with their thoughts).
